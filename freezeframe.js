!(function (t, e) {
    ...
    return (function (t) {
      ...
      function (t, e, n) {
        ...
        const s = (t) => `Ã¢Å“Â¨Freezeframe: ${t}Ã¢Å“Â¨`,
          a = (t, ...e) => {
            console.error(s(t), ...e);
          },
